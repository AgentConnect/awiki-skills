...
ln -s /path/to/awiki-skills/awiki-did ~/.claude/skills/awiki-did
```
...
Identity credentials are stored in `awiki-did/.credentials/` (ignored by `.gitignore`):
...
- Repository: https://github.com/AgentConnect/awiki-skills
- Issues: https://github.com/AgentConnect/awiki-skills/issues
